...
ComputationWrapper::ComputationWrapper(ComputationEngine &computation_engine) :
...
std::vector<int> ComputationWrapper::GetAllUnits() const 
{
    std::vector<int> ret;
...
RealT ComputationWrapper::ComputeSolutionNormBound(const std::vector<int> &units,
...
RealT ComputationWrapper::ComputeGradientNormBound(const std::vector<int> &units,
                                                          const std::vector<RealT> &C,
                                                          RealT log_base)
{
    Assert(computation_engine.IsMasterNode(), "Routine should only be called by master process.");
...
std::vector<int> ComputationWrapper::FilterNonparsable(const std::vector<int> &units)
{
    Assert(computation_engine.IsMasterNode(), "Routine should only be called by master process.");
...
RealT ComputationWrapper::ComputeLoss(const std::vector<int> &units,
...
RealT ComputationWrapper::ComputeFunction(const std::vector<int> &units,
                                                 const std::vector<RealT> &w,
...
std::vector<RealT> ComputationWrapper::ComputeGradient(const std::vector<int> &units,
                                                              const std::vector<RealT> &w,
                                                              bool toggle_use_nonsmooth,
                                                              bool toggle_use_loss,
                                                              RealT log_base,
...
RealT ComputationWrapper::ComputeEMFunction(const std::vector<int> &units,
                                                 const std::vector<RealT> &w,
                                                 bool toggle_use_nonsmooth,
                                                 bool toggle_use_loss,
                                                 RealT log_base)
...
std::vector<RealT> ComputationWrapper::ComputeEMGradient(const std::vector<int> &units,
                                                              const std::vector<RealT> &w,
                                                              bool toggle_use_nonsmooth,
                                                              bool toggle_use_loss,
                                                              RealT log_base)
...
RealT ComputationWrapper::ComputeFunctionSE(const std::vector<int> &units,
                                                   const std::vector<RealT> &w,
                                                   bool toggle_use_nonsmooth,
                                                   bool toggle_use_loss,
                                                   RealT log_base,
...
std::vector<RealT> ComputationWrapper::ComputeGradientSE(const std::vector<int> &units,
                                                                const std::vector<RealT> &w,
                                                                bool toggle_use_nonsmooth,
                                                                bool toggle_use_loss,
                                                                RealT log_base,
...
RealT ComputationWrapper::ComputeGammaMLEFunction(const std::vector<int> &units,
                                                 const std::vector<RealT> &w,
                                                 bool toggle_use_nonsmooth,
                                                 bool toggle_use_loss,
                                                 RealT log_base,
...
std::vector<RealT>  ComputationWrapper::ComputeGammaMLEGradient(const std::vector<int> &units,
                                                 const std::vector<RealT> &w,
                                                 bool toggle_use_nonsmooth,
                                                 bool toggle_use_loss,
                                                 RealT log_base,
...
std::vector<RealT> ComputationWrapper::ComputeGammaMLEScalingFactor(const std::vector<int> &units,
                                                 const std::vector<RealT> &w,
...
bool ComputationWrapper::FindZerosInData(const std::vector<int> &units, int evidence_cpd_id1, int evidence_cpd_id2, int which_data)
{
...
std::vector<RealT> ComputationWrapper::ComputeHessianVectorProduct(const std::vector<int> &units,
                                                                          const std::vector<RealT> &w,
...
void ComputationWrapper::Predict(const std::vector<int> &units,
                                        const std::vector<RealT> &w,
                                        RealT gamma,
                                        RealT log_base)
{
...
void ComputationWrapper::PredictFoldChange(const std::vector<int> &units,
                                        const std::vector<RealT> &w,
                                        RealT gamma,
                                        RealT log_base)
{
...
void ComputationWrapper::SanityCheckGradient(const std::vector<int> &units,
