...
InnerOptimizationWrapperStochasticGradient::InnerOptimizationWrapperStochasticGradient(OptimizationWrapper *optimization_wrapper,
...
RealT InnerOptimizationWrapperStochasticGradient::ComputeFunction(const std::vector<RealT> &w)
{
...
void InnerOptimizationWrapperStochasticGradient::ComputeGradient(std::vector<RealT> &g, const std::vector<RealT> &w, const int batch_size)
{
...
int InnerOptimizationWrapperStochasticGradient::GetLogicalIndex(int i, int j, int k, int which_data)
{
...
//////////////////////////////////////////////////////////////////////
bool InnerOptimizationWrapperStochasticGradient::FindZerosInData(int i, int j, int which_data)
{
...
void InnerOptimizationWrapperStochasticGradient::Report(int iteration, const std::vector<RealT> &w, RealT step_size)
{
...
void InnerOptimizationWrapperStochasticGradient::Report(const std::string &s)
{
...
RealT InnerOptimizationWrapperStochasticGradient::Minimize(std::vector<RealT> &x0)
{
    // RealT result = 0;
    std::vector<RealT> g;
